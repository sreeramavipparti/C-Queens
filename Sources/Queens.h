 ...
 *  Function for this is powersOf2()
 *
 * 2. Board size evenly even i.e. divisible by 4
 *    - No logic decided yet
 *  Function for this is evenlyEven()
 *
 * 3. All other even numbers
 ...
 *
 * 4. Odd numbers divisible by 3 ie 9, 15, 21, ...
...
void powersOf2(posint size); /* Task 1 above */
void evenlyEven(posint size); /* Task 2 above */
void even(posint size); /* Task 3 above */
void oddDivBy3(posint size); /* Task 4 above */
void odd(posint size); /* Task 5 above */
